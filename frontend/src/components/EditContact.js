...
const EditContact = () => {
  ...
  const {_id,name,number,email} = location.state.contact;
  ...
  const update = (e) => {
    ...
    // console.log("Before update: ",{_id,name: newName,number: newNumber,email: newEmail});
    editContactHandler({_id,name:newName,number:newNumber,email:newEmail});
    setNewName("");
    setNewNumber("");
    setNewEmail("");
    navigate("/");
